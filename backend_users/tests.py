...
class AuthenticationTestCase(APITestCase):
    def test_signup(self):
        ...
        self.assertEqual(response.json()["error"][0], "Username: A user with that username already exists.")
        ...
        self.assertEqual(response.status_code, status.HTTP_400_BAD_REQUEST)
        self.assertEqual(response.json()["error"][0], "Username: This field may not be blank.")
        self.assertEqual(response.json()["error"][1], "Password: This field may not be blank.")
    ...
    def test_login(self):
        ...
        self.assertEqual(response.status_code, status.HTTP_400_BAD_REQUEST)
        self.assertEqual(response.json()["error"][0], "Invalid username or password.")
